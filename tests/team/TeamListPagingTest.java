 ...
 */
public class TeamListPagingTest {

    /**
     * Main page object of testing Web site.
     */
    private TeamListPage teamPage;
    ...
    public final void setUp() {
        ...
        teamPage = SetPreconditions.forTeamPagingTest();
    }
    ...
    public final void teamListPaging() {
        Specification.get().For(teamPage)
                .readTeamsFromDB()
