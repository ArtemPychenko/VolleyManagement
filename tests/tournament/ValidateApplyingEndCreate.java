...
import com.softserveinc.ita.volleymanagementtests.tools.WebDriverUtils;
     ...
     *
     */
public class ValidateApplyingEndCreate {
        ...
        /**
         * Test verifies that if invalid data in applying end field is entered
        ...
        public final void invalidDate() {
            ...
            invalidDateList = TournamentTestObjects
                    .getInvalidDateForApplyingEnd();
            for (String date: invalidDateList) {
                ...
                newTournamentPage.getData().setApplyingEndInput(date);
             ...
             * applying end input - the tournament will be saved in data base.
             */
            @Test
            public final void validDate() {
                ...
                tournamentInDB = TournamentRepository.countAllTournaments();
                tournament = TournamentTestObjects.getValidTournament();
                tournament.setApplyingPeriodEnd(tournament
                        .getApplyingPeriodStart());
                newTournamentPage = homePage.getNavigationPage()
                        .getTournamentListPage().openCreateTournamentPage();
                newTournamentPage.getData().setAllFields(tournament);
                newTournamentPage.pressSaveWithoutReturnPage();
                ...
                //Negative test - tournament should not be saved in DB.
                //Applying Start < current date
                tournament.setApplyingPeriodEnd(
                        TournamentTestObjects
                        .getLowerDate(tournament.getApplyingPeriodEnd()));
                newTournamentPage = homePage.getNavigationPage()
                        .getTournamentListPage().openCreateTournamentPage();
                newTournamentPage.getData().setAllFields(tournament);
                newTournamentPage.pressSaveWithoutReturnPage();
