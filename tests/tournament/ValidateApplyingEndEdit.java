 ...
 *
 */
public class ValidateApplyingEndEdit {
    /**
    ...
    /**
     * Test verifies that if invalid data in applying end is entered
    ...
    public final void invalidDate() {
        ...
        for (String date: invalidDateList) {
            ...
            editTournamentPage = tournamentListPage.showTournamentInfo(
                    validTournament)
                    .pressEditButton();
            editTournamentPage.getData().setApplyingEndInput(date);
         ...
         * applying end input - the tournament will be added in data base.
         */
        @Test
        public final void validDate() {
            ...
            editTournamentPage = tournamentListPage.showTournamentInfo(
                    validTournament)
                    .pressEditButton();
            editTournamentPage.getData().setApplyingEndInput(tournament);
