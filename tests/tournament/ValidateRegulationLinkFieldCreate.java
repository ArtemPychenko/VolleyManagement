...
import com.softserveinc.ita.volleymanagementtests.tools.WebDriverUtils;
    ...
    /**
     * This class validates the regulations link field through create team page.
     * @author Aleksandr Zaitsev
     *
     */
public class ValidateRegulationLinkFieldCreate {
        ...
        public final void validateTeamsNameField() {
            ...
            /**
             * The tournament shouldn't be save in the database, because of 255
             * symbols is max but 256 are entered.
             * The validation message should appear.
             */
            tournament = TournamentTestObjects.getInvlidRegulationsLinkSize();
            ...
            .valueMatch(TestsConstants.VALIDATION_ERROR_TEXT_TOO_BIG_LINK)
            .next()
            .For(repository)
            ...
            = TournamentTestObjects.getValidRegulationsLink();
