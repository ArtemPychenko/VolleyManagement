 ...
 * 
 */
public class ValidateTournamentStartDateFieldUpdate {
    /**
    ...
    public final void validateTournamentStartDateFieldCreate() {
       ...
       for (String invalidDate : invalidDates) {
           ...
           editTournamentPage.getData().getTournamentStartInput().clear();
           editTournamentPage.getData().getTournamentStartInput()
                   .type(invalidDate);
       ...
       specification
       .For(editTournamentPage.getData().getErrorMessageLabelTournamentStart())
       .valueMatch(TestsConstants
