...
/**
 * This test-case for validation start tournament date field  
 ...
 * 
 */
public class ValidateTournamentStartDateFieldCreate {
    /**
    ...
    public final void validateTournamentStartDateFieldCreate() {
       ...
       for (String invalidDate : invalidDates) {
           ...
           newTournamentPage.getData().getTournamentStartInput().clear();
           newTournamentPage.getData().getTournamentStartInput()
                   .type(invalidDate);
           newTournamentPage.unsuccessfulPressSave();
                                
           specification
           .For(newTournamentPage.getData()
                   .getErrorMessageLabelTournamentStart())
       ...
       String invalidDate = TournamentTestObjects.getInvalidEmptyTypeForDate();
       tuornamentsInDBBeforTest = TournamentRepository
               .countAllTournaments();
       newTournamentPage = tournamentListPage.openCreateTournamentPage();
       newTournamentPage.getData().setAllFields(validTournament);
       ...
       specification
       .For(newTournamentPage.getData().getErrorMessageLabelTournamentStart())
       .valueMatch(TestsConstants
