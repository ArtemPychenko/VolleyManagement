 ...
 * 
 */
public class ValidateTournamentEndDateFieldCreate {
    /**
    ...
    public final void validateTournamentStartDateFieldCreate() {
       ...
       for (String invalidDate : invalidDates) {
           ...
           newTournamentPage.getData().getTournamentEndInput().clear();
           newTournamentPage.getData().getTournamentEndInput()
                   .type(invalidDate);
           newTournamentPage.unsuccessfulPressSave();
                                
           specification
           .For(newTournamentPage.getData().getErrorMessageLabelTournamentEnd())
