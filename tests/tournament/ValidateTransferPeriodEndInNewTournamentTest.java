 ...
 */
public class ValidateTransferPeriodEndInNewTournamentTest {
    ...
    public final void dontCorrectDate() {
        ...
        for (String date : newDateList) {
            ...
            newTournamentPage.getData().setTransferStartInput(newTournament);
            newTournamentPage.getData().setTransferEndInput(date);
    ...
    public final void validDate() {
        ...
        tournamentInDB = TournamentRepository.countAllTournaments();
        // Tournament Start < Transfer End < Tournament End
