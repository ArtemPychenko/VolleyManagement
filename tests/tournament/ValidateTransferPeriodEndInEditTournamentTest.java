...
/**
 * This test case validate transfer period end field in edit tournament page.
 * @author Dmytro Maslov.
 */
public class ValidateTransferPeriodEndInEditTournamentTest {
    ...
    public final void dontCorrectDate() {
        ...
        for (String date : newDateList) {
            editTournamentPage = homePage.getNavigationPage()
                    ...
                    .pressEditButton();
            editTournamentPage.getData().setTransferEndInput(date);
    ...
    public final void validDate() {
        ...
        newTournament.setTransferEnd(newTournament.getTransferStart());
        editTournamentPage = homePage.getNavigationPage()
                .getTournamentListPage().showFirstTournament()
                .pressEditButton();
        editTournamentPage.getData().setTransferEndInput(newTournament);
        editTournamentPage.pressSaveWithoutReturnPage();
        specification.For(repository)
                .numberOfTournamentsHasNotChanged(tournamentInDB)
                .isTournamentPresent(newTournament).next();
        // Tournament Start < Transfer Start < Tournament End
        newTournament.setTransferEnd(TournamentTestObjects
                .getLowerDate(newTournament.getGamesEnd()));
        editTournamentPage = homePage.getNavigationPage()
                .getTournamentListPage().showFirstTournament()
                .pressEditButton();
        editTournamentPage.getData().setTransferEndInput(newTournament);
