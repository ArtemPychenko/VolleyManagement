 ...
 * Test verifies the player's height input of the create player page.
 */
public class ValidateHeightFieldCreate {
    /**
    ...
    public final void heightFieldStringdNegativeTest() {
        newPlayerPage = homePage.getNavigationPage().getPlayersPage()
            ...
            for (String invalidHeight : invalidHeightAsStrings) {
                ...
                newPlayerPage.getData().getHeightInput().clear();
                newPlayerPage.getData().getHeightInput().type(invalidHeight);
                newPlayerPage.unsuccessfulPressSave();

                specification
                .For(newPlayerPage.getData().getErrorMessageLabelHeight())
